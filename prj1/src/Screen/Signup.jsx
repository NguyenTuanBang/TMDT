...
import FadeContent from "../Comp/FadeContent.jsx";
import { useEffect, useState } from "react";
import api from "../utils/api.jsx";
import useToast from "../hooks/useToast.jsx";
import SpinnerLoad from "../Comp/Spinner.jsx";
import CountdownTimer from "../Comp/CountDownTimer.jsx";
...
import InputOTP from "../Comp/InputOtp.jsx";
        ...
        {!openOtp ? (
          <>
            ...
            <p className="text-sm text-gray-600 text-center">
              Đã có tài khoản?{" "}
              <Link to="/authen/login" className="text-blue-600 hover:underline">
                Đăng nhập
              </Link>
            </p>
          </>
