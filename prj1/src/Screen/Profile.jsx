...
export default function Profile({ user, setUser }) {
  ...
  useEffect(() => {
    if (user.avatar) {
      setPreview(`http://localhost:8080/img/avatars/${user.avatar}`);
    } else {
      setPreview('https://via.placeholder.com/40');
    }
  }, [user]);
    ...
    try {
      ...
      setPreview(
        values.avatar instanceof File
          ...
          : updatedUser.avatar
          ? `http://localhost:8080/img/avatars/${updatedUser.avatar}`
          : "http://localhost:8080/img/avatars/default.png"
      );
